...
DOCUMENTATION = r"""
---
module: scaleway_function_v1beta1_trigger
short_description: Manage Scaleway function_v1beta1's trigger
description:
    - This module can be used to manage Scaleway function_v1beta1's trigger.
version_added: "2.1.0"
author:
...
- name: Create a trigger
  scaleway.scaleway.scaleway_function_v1beta1_trigger:
