...
DOCUMENTATION = r"""
---
module: scaleway_registry_v1_namespace
short_description: Manage Scaleway registry_v1's namespace
description:
    - This module can be used to manage Scaleway registry_v1's namespace.
version_added: "2.1.0"
author:
...
- name: Create a namespace
  scaleway.scaleway.scaleway_registry_v1_namespace:
