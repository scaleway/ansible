...
DOCUMENTATION = r"""
---
module: scaleway_iam_v1alpha1_policy
short_description: Manage Scaleway iam_v1alpha1's policy
description:
    - This module can be used to manage Scaleway iam_v1alpha1's policy.
version_added: "2.1.0"
author:
...
- name: Create a policy
  scaleway.scaleway.scaleway_iam_v1alpha1_policy:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("policy_id", None)
    if id is not None:
        resource = api.get_policy(policy_id=resource_id)
    ...
    resource = api.create_policy(**not_none_params)
