...
DOCUMENTATION = r"""
---
module: scaleway_container_v1beta1_cron
short_description: Manage Scaleway container_v1beta1's cron
description:
    - This module can be used to manage Scaleway container_v1beta1's cron.
version_added: "2.1.0"
author:
...
EXAMPLES = r"""
- name: Create a cron
  scaleway.scaleway.scaleway_container_v1beta1_cron:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("cron_id", None)
    if id is not None:
        resource = api.get_cron(cron_id=resource_id)
