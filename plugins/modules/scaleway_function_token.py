...
DOCUMENTATION = r"""
---
module: scaleway_function_token
short_description: Manage Scaleway function's token
description:
    - This module can be used to manage Scaleway function's token.
version_added: "2.1.0"
author:
...
def delete(module: AnsibleModule, client: Client) -> None:
    ...
    module.exit_json(
        changed=True,
        msg=f"function's token {resource.name} ({resource.id}) deleted",
    )
...
def main() -> None:
    ...
    argument_spec.update(
        ...
        function_id=dict(type="str", required=False),
