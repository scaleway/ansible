...
DOCUMENTATION = r"""
---
module: scaleway_function_v1beta1_token
short_description: Manage Scaleway function_v1beta1's token
description:
...
EXAMPLES = r"""
- name: Create a token
  scaleway.scaleway.scaleway_function_v1beta1_token:
...
def delete(module: AnsibleModule, client: "Client") -> None:
    ...
    module.exit_json(
        changed=True,
        msg=f"function_v1beta1's token {resource.id} deleted",
    )
