...
DOCUMENTATION = r"""
---
module: scaleway_iam_v1alpha1_ssh_key
short_description: Manage Scaleway iam_v1alpha1's ssh_key
description:
    - This module can be used to manage Scaleway iam_v1alpha1's ssh_key.
version_added: "2.1.0"
author:
...
- name: Create a ssh_key
  scaleway.scaleway.scaleway_iam_v1alpha1_ssh_key:
...
def delete(module: AnsibleModule, client: "Client") -> None:
    ...
    if resource_id is not None:
        resource = api.get_ssh_key(
            ssh_key_id=resource_id,
        )
    elif module.params.get("name", None) is not None:
        resources = api.list_ssh_keys_all(
