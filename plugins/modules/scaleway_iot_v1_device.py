...
DOCUMENTATION = r"""
---
module: scaleway_iot_v1_device
short_description: Manage Scaleway iot_v1's device
description:
    - This module can be used to manage Scaleway iot_v1's device.
version_added: "2.1.0"
author:
...
- name: Create a device
  scaleway.scaleway.scaleway_iot_v1_device:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("device_id", None)
    if id is not None:
        resource = api.get_device(device_id=resource_id)
    ...
    resource = api.create_device(**not_none_params)
