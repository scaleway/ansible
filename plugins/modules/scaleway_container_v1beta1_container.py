...
DOCUMENTATION = r"""
---
module: scaleway_container_v1beta1_container
short_description: Manage Scaleway container_v1beta1's container
description:
    - This module can be used to manage Scaleway container_v1beta1's container.
version_added: "2.1.0"
author:
...
- name: Create a container
  scaleway.scaleway.scaleway_container_v1beta1_container:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("container_id", None)
    if id is not None:
        resource = api.get_container(container_id=resource_id)
