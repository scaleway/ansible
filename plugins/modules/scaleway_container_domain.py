...
DOCUMENTATION = r"""
---
module: scaleway_container_domain
short_description: Manage Scaleway container's domain
description:
    - This module can be used to manage Scaleway container's domain.
version_added: "2.1.0"
author:
...
- name: Create a domain
  scaleway.scaleway.scaleway_container_domain:
