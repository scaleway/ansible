...
DOCUMENTATION = r"""
---
module: scaleway_lb_v1_route
short_description: Manage Scaleway lb_v1's route
description:
    - This module can be used to manage Scaleway lb_v1's route.
version_added: "2.1.0"
author:
...
EXAMPLES = r"""
- name: Create a route
  scaleway.scaleway.scaleway_lb_v1_route:
