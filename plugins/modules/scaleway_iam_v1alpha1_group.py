...
DOCUMENTATION = r"""
---
module: scaleway_iam_v1alpha1_group
short_description: Manage Scaleway iam_v1alpha1's group
description:
    - This module can be used to manage Scaleway iam_v1alpha1's group.
version_added: "2.1.0"
author:
...
EXAMPLES = r"""
- name: Create a group
  scaleway.scaleway.scaleway_iam_v1alpha1_group:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("group_id", None)
    if id is not None:
        resource = api.get_group(group_id=resource_id)
...
def delete(module: AnsibleModule, client: "Client") -> None:
    ...
    if resource_id is not None:
        resource = api.get_group(
            group_id=resource_id,
        )
    elif module.params.get("name", None) is not None:
        resources = api.list_groups_all(
