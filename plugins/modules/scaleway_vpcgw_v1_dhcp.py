...
DOCUMENTATION = r"""
---
module: scaleway_vpcgw_v1_dhcp
short_description: Manage Scaleway vpcgw_v1's dhcp
description:
    - This module can be used to manage Scaleway vpcgw_v1's dhcp.
version_added: "2.1.0"
author:
...
EXAMPLES = r"""
- name: Create a dhcp
  scaleway.scaleway.scaleway_vpcgw_v1_dhcp:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("dhcp_id", None)
    if id is not None:
        resource = api.get_dhcp(dhcp_id=resource_id)
