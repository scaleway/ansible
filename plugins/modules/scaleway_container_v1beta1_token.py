...
DOCUMENTATION = r"""
---
module: scaleway_container_v1beta1_token
short_description: Manage Scaleway container_v1beta1's token
description:
...
EXAMPLES = r"""
- name: Create a token
  scaleway.scaleway.scaleway_container_v1beta1_token:
...
def delete(module: AnsibleModule, client: "Client") -> None:
    ...
    module.exit_json(
        changed=True,
        msg=f"container_v1beta1's token {resource.id} deleted",
    )
