...
def main() -> None:
    ...
    argument_spec.update(
        ...
        runtime=dict(
            type="str",
            required=True,
            choices=["unknown_runtime", "golang", "python", "python3", "node8", "node10", "node14", "node16", "node17", "python37", "python38", "python39", "python310", "go113", "go117", "go118", "node18", "rust165", "go119", "python311", "php82", "node19", "go120", "node20"],
        ),
        privacy=dict(
            type="str",
            required=True,
