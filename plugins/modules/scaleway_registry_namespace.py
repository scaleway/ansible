...
short_description: Manage Scaleway registry's namespace
description:
    - This module can be used to manage Scaleway registry's namespace.
version_added: "2.1.0"
author:
...
def create(module: AnsibleModule, client: Client) -> None:
    ...
    resource = api.wait_for_namespace(namespace_id=resource.id)
...
def delete(module: AnsibleModule, client: Client) -> None:
    ...
    api.delete_namespace(namespace_id=resource.id)

    try:
        api.wait_for_namespace(namespace_id=resource.id)
    ...
    module.exit_json(
        changed=True,
        msg=f"registry's namespace {resource.name} ({resource.id}) deleted",
    )
