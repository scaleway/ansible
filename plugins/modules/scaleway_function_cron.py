...
DOCUMENTATION = r"""
---
module: scaleway_function_cron
short_description: Manage Scaleway function's cron
description:
    - This module can be used to manage Scaleway function's cron.
version_added: "2.1.0"
author:
...
def create(module: AnsibleModule, client: Client) -> None:
    ...
    resource = api.wait_for_cron(cron_id=resource.id)
...
def delete(module: AnsibleModule, client: Client) -> None:
    ...
    api.delete_cron(cron_id=resource.id)

    try:
        api.wait_for_cron(cron_id=resource.id)
    ...
    module.exit_json(
        changed=True,
        msg=f"function's cron {resource.name} ({resource.id}) deleted",
    )
