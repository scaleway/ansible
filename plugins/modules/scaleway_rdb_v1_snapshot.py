...
DOCUMENTATION = r"""
---
module: scaleway_rdb_v1_snapshot
short_description: Manage Scaleway rdb_v1's snapshot
description:
    - This module can be used to manage Scaleway rdb_v1's snapshot.
version_added: "2.1.0"
author:
...
- name: Create a snapshot
  scaleway.scaleway.scaleway_rdb_v1_snapshot:
