...
DOCUMENTATION = r"""
---
module: scaleway_rdb_v1_endpoint
short_description: Manage Scaleway rdb_v1's endpoint
description:
    - This module can be used to manage Scaleway rdb_v1's endpoint.
version_added: "2.1.0"
author:
...
- name: Create a endpoint
  scaleway.scaleway.scaleway_rdb_v1_endpoint:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("endpoint_id", None)
    if id is not None:
        resource = api.get_endpoint(endpoint_id=resource_id)
