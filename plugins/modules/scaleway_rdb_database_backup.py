...
def create(module: AnsibleModule, client: Client) -> None:
    ...
    resource = api.wait_for_database_backup(database_backup_id=resource.id)
...
def delete(module: AnsibleModule, client: Client) -> None:
    ...
    api.delete_database_backup(database_backup_id=resource.id)

    try:
        api.wait_for_database_backup(database_backup_id=resource.id)
