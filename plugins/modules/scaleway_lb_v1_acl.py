...
DOCUMENTATION = r"""
---
module: scaleway_lb_v1_acl
short_description: Manage Scaleway lb_v1's acl
description:
    - This module can be used to manage Scaleway lb_v1's acl.
version_added: "2.1.0"
author:
...
EXAMPLES = r"""
- name: Create a acl
  scaleway.scaleway.scaleway_lb_v1_acl:
...
def create(module: AnsibleModule, client: "Client") -> None:
    ...
    resource_id = module.params.pop("acl_id", None)
    if id is not None:
        resource = api.get_acl(acl_id=resource_id)
...
def delete(module: AnsibleModule, client: "Client") -> None:
    ...
    if resource_id is not None:
        resource = api.get_acl(
            acl_id=resource_id,
            zone=module.params["zone"],
        )
    elif module.params.get("name", None) is not None:
        resources = api.list_acls_all(
            name=module.params["name"],
            frontend_id=module.params.get("frontend_id", None),
            zone=module.params["zone"],
        )
        if len(resources) == 0:
