...
DOCUMENTATION = r"""
---
module: scaleway_account_v2_project
short_description: Manage Scaleway account_v2's project
description:
    - This module can be used to manage Scaleway account_v2's project.
version_added: "2.1.0"
author:
...
- name: Create a project
  scaleway.scaleway.scaleway_account_v2_project:
